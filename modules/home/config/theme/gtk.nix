...
with lib; let
  ...
  extraCss = with theme.palette; ''
    ...
    @define-color accent_bg_color #${accent};            /* Color to indicate that a widget is important, interactive, or currently active */
    @define-color accent_fg_color #${base11};            /* Color for text over widgets using accent_bg_color */
    @define-color accent_color #${accent};              /* Mostly used for text labels. Can be the same as accent_bg_color */
